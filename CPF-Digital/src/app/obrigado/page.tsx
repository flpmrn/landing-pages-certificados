...
export default function ObrigadoPage() {
    return (
        <div className="min-h-screen bg-navy-blue flex items-center justify-center p-4 text-center bg-[url('https://images.unsplash.com/photo-1573164713988-8665fc963095?q=80&w=2669&auto=format&fit=crop')] bg-cover bg-center">
            ...
            <div className="bg-white p-10 md:p-14 rounded-3xl max-w-lg shadow-2xl relative z-10 animate-fade-in-up">
                ...
                <p className="font-inter text-gray-600 mb-8 leading-relaxed">
                    A sua solicitação foi enviada para a nossa fila de atendimento prioritário. Em breve, um especialista em certificação digital entrará em contato com você via WhatsApp ou E-mail para prosseguir com a validação do seu e-CPF por videoconferência.
                </p>
