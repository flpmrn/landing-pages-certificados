...
export default function FeatureGrid({ title, features }: FeatureGridProps) {
    ...
    const icons = [
        <Zap key="1" className="w-10 h-10 text-navy-blue mb-4" strokeWidth={1.5} />,
        <Video key="2" className="w-10 h-10 text-navy-blue mb-4" strokeWidth={1.5} />,
        <ShieldCheck key="3" className="w-10 h-10 text-navy-blue mb-4" strokeWidth={1.5} />,
        <LayoutDashboard key="4" className="w-10 h-10 text-navy-blue mb-4" strokeWidth={1.5} />,
        <MonitorSmartphone key="5" className="w-10 h-10 text-navy-blue mb-4" strokeWidth={1.5} />,
        <Lock key="6" className="w-10 h-10 text-navy-blue mb-4" strokeWidth={1.5} />
    ];
